...
add_fd('Arkyo', 'Nanahira', aka='Lok', discord='Ahlok')
add_fd('Nanahira', '過期方包', aka='Bread', discord='Breeaad')
...
add_unknown('unlegitbruh', True)
add_alt('unlegitbruh', 'unlegitbruh²')
add_alt('unlegitbruh', 'unlegitbruh³')
add_fd('Tissuepaper', 'duckss')
add_fd('no.', 'the boss')
add_fd('雪儿', 'ttleong', aka='tt')
add_fd('Arkyo', 'Bruck', discord='bruck')
